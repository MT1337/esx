...
-- Useful thing that notix implemented on his server --
Shared.Items = {
	[1] = {name = 'bread', label = 'Bread', weight = 1, rare = 0, canRemove = 1},
	[2] = {name = 'water', label = 'Water', weight = 1, rare = 0, canRemove = 1}
}

Shared.Jobs = {
	[1] = {name = 'unemployed', label = 'Unemployed', whitelisted = false, mainGradename = 'unemployed', mainGradelabel = 'Unemployed', salary = 50, skin_male = '{}', skin_female = '{}'},
	[2] = {name = 'police', label = 'Police', whitelisted = true, mainGradename = 'junior', mainGradelabel = 'Newbie', salary = 150, skin_male = '{}', skin_female = '{}'},
}
